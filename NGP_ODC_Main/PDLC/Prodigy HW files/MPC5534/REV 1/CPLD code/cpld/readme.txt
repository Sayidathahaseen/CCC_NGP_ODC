Altera Complete Design Suite Release 7.2 README.TXT
=================================================================
...
*  MegaCore IP Library, which includes the following MegaCore 
   functions and their corresponding user guides
      2D FIR Filter                             v7.2  
      2D Median Filter                          v7.2 
      8B10B Encoder/Decoder                     v7.2 
      Alpha Blending Mixer                      v7.2 
      ASI                                       v7.2 
      CIC Compiler                              v7.2 
      Color Space Converter                     v7.2 
      CRC Compiler                              v7.2 
      Chroma Resampler                          v7.2 
      DDR & DDR2 SDRAM Controller               v7.2 
      DDR SDRAM High Performance Controller     v7.2 
      DDR2 SDRAM High Performance Controller    v7.2 
      Deinterlacer                              v7.2 
      FFT/IFFT                                  v7.2 
      FIR Compiler                              v7.2 
      Gamma Corrector                           v7.2 
      HyperTransport                            v7.2 
      Line Buffer Compiler                      v7.2 
      NCO Compiler                              v7.2 
      Nios II Embedded Processor                v7.2 
      PCI Compiler                              v7.2 
      PCI Express Compiler                      v7.2 
      POS-PHY Level 2 & 3 Compiler              v7.2 
      POS-PHY Level 4                           v7.2 
      QDRII SRAM Controller                     v7.2 
      RapidIO                                   v7.2 
      Reed-Solomon Compiler (Decoder & Encoder) v7.2 
      RLDRAM II Controller                      v7.2 
      HD/SD SDI                                 v7.2 
      Scaler                                    v7.2 
      SerialLite II                             v7.2 
      Triple Speed Ethernet                     v7.2 
      UTOPIA Level 2 Master                     v7.2 
      UTOPIA Level 2 Slave                      v7.2 
      Viterbi Compiler                          v7.2 
...
7.1 Service Pack 1 requires approximately 5 GB of available disk 
space on the drive or partition where you are installing the 
Altera Complete Design Suite and approximately 30 MB of available 
space on the drive that contains your TEMP directory (Windows only).
